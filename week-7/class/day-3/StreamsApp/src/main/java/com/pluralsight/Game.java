...
public class Game {
    public static void main(String[] args) {
        ...
        /**
         * Collection, explicit, multi-step transformation and destination
         */
//        ArrayList<Card> selectedPlayersUnoCards = new ArrayList<>();
//
//        for(Card card : unoCardHand.getCards()) {
//            if(card.getType().equalsIgnoreCase("green")) {
//                selectedPlayersUnoCards.add(card);
//            }
//        }
//
//        for(Card card : selectedPlayersUnoCards) {
//            System.out.println("Card type: " + card.getType() + " Card Effect: " + card.getEffect());
//        }


        /**
         * multi-step transformation, one destination
         */
        unoCardHand.getCards().stream()
            .filter(card -> card.getType().equalsIgnoreCase("green"))
            .forEach(card -> System.out.println("Card type: " + card.getType() + " Card Effect: " + card.getEffect()));
